...
class ExpressionTests extends TestSet {
  ...
  void initTests() {
    ...
    int1 = new Alg.Interval(num1, num2);
    int2 = new Alg.Interval(num2, num3);
    int3 = new Alg.Interval(-num3, num2);;

    i1 = new Interval(n1, n2);
    i2 = new Interval(n2, n3);
    i3 = new Interval(-n3, n2);
...
//    expect(_hasMember(e3, i1, i2), isTrue);
  ...
  void simpleIntervalEval() {
    ...
    Alg.Interval ri1 = new Alg.Interval(num1, num1),
                 ri2 = new Alg.Interval(num2, num2),
                 ri3 = new Alg.Interval(num3, num3);
